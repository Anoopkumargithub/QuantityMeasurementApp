namespace QuantityMeasurement.OperationService.Configuration;
...
public sealed class ServiceDiscoveryOptions
{
    ...
    public string ServiceName { get; set; } = "quantity-operation-service";
    public string ServiceUrl { get; set; } = "http://localhost:7001";
